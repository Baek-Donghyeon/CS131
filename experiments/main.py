...
keypoints_num = 15
cubic_size = 2.0
point_of_view = 'side' # 'top' or 'side'
...
# Dataset and loader
train_set = ITOPDataset(data_dir, center_dir, point_of_view, 'train',  transform_train)
...
val_set = ITOPDataset(data_dir, center_dir, point_of_view, 'test',  transform_val)
...
if device == torch.device('cuda'):
    torch.backends.cudnn.enabled = True # True
...
test_set = ITOPDataset(data_dir, center_dir, 'top', 'test', transform_test)
...
fit_set = ITOPDataset(data_dir, center_dir, point_of_view, 'train', transform_test)
